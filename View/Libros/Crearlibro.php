    ...
    <form method='POST'>
        ...
        <div class='row'>
            ...
            <div class='col-6 col-sm-4'>
                <input type='text' class='form-control mt-4' placeholder='' name='NombreLibro' required>
            </div>
        </div>
        ...
        <div class='row'>
            ...
            <div class='col-6 col-sm-4'>
                <input type='text' class='form-control mt-4' placeholder='' name='precio' required>
            </div>
        </div>
        ...
        <div class='row'>
            ...
            <div class='col-6 col-sm-4'>
                <input type='text' class='form-control mt-4' placeholder='' name='Cantidad' required>
            </div>
        </div>
        ...
        <div class='row'>
            ...
            <div class='col-6 col-sm-4'>
                <input type='text' class='form-control mt-4' placeholder='' name='Anio' required>
            </div>
        </div>
        ...
        <div class='row'>
            ...
            <div class='col-6 col-sm-4'>
                <textarea class='form-control mt-4' name='Desc' rows='3'></textarea>
            </div>
        </div>

        <div class='row'>
            <div class='col-12 col-sm-7'>
                <button type='submit' class='btn btn-primary btn-lg mt-4'>Registrar Libro</button>
            </div>
        </div>
